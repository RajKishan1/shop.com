...
const BannerDiv = () => {
  return (
    <div className="pl-[100px] w-[1440px] h-[663px] bg-[url('/bannerBG.svg')] bg-cover">
      <div className="w-1/2 h-full bg-slate-00 ">
        <h1 className={`${Lilita.className} text-black text-[62px]`}>
        ...
        <div className="h-[74px] w-[596px] bg-red-100 flex gap-[32px] justify-between">
